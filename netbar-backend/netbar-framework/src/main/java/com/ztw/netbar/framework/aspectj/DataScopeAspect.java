package com.ztw.netbar.framework.aspectj;
...
import com.ztw.netbar.common.annotation.DataScope;
...
import com.ztw.netbar.common.core.domain.entity.SysRole;
import com.ztw.netbar.common.core.domain.entity.SysUser;
import com.ztw.netbar.common.core.domain.model.LoginUser;
import com.ztw.netbar.common.core.text.Convert;
import com.ztw.netbar.common.utils.SecurityUtils;
import com.ztw.netbar.common.utils.StringUtils;
import com.ztw.netbar.framework.security.context.PermissionContextHolder;
...
public class DataScopeAspect
{
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String userAlias, String deptAlias, String userField, String deptField, String permission)
    {
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            {
                sqlString.append(StringUtils.format(" OR {}.{} = {} ", deptAlias, deptField, 0L));
            }
            else if (Constants.Dept.DATA_SCOPE_DEPT_AND_CHILD.equals(dataScope))
            {
                sqlString.append(StringUtils.format(" OR {}.{} IN ( SELECT dept_id FROM sys_dept WHERE dept_id = {} or find_in_set( {} , ancestors ) )", deptAlias, deptField, 0L, 0L));
            }
